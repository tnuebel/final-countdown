    ...
    <Title />
        ...
        <div className="pad1">
            <div className="row row-one">
                <div className="col-sm"><Link to="/News" className="button outerButtonTopLetf">
                    <img src={News} alt="news"/><br />News</Link></div>
                <div className="col-sm-3"><a href="/Purpose" className="button centerButton"><span>Purpose</span><br /><span className="comment">WHY WE GO</span></a></div>
                <div className="col-sm"><a href="/Watch" className="button outerButtonTopRight">
                    <img src={Watch} alt="watch"/><br />Watch</a></div>
            </div>

            <div className="row row-two">
                <div className="col-sm"><a href="Gallery" className="button">
                    <img src={Gallery} alt="gallery"/><br />Gallery</a></div>
                <div className="col-sm"><a href="Button" className="button">
                    <img src={SignIn} alt="sign"/><br />Sign In</a></div>
                <div className="col-sm-3"><Link to="/Mission" className="button centerButton" ><span>Mission</span><br /><span className="comment">WHAT WE DO</span></Link></div>
            ...
            <div className="row row-three">
                ...
                <div className="col-sm"><a href="/Research Flights" className="button outerButtonRight">Research Flights</a></div>
            </div>
