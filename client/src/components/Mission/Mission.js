            ...
            <div className="whiteTxt">
                <div className="container">
                    <div className="row">
                        ...
                        <h2 className="h1">The Final Countdown's Mission</h2>
                        <br />

                            <h3>Mission Statement:</h3>

                            <p>At The Final Countdown we are driven by our motto, Gradatim Ferociter, or “step by step, ferociously.” Our goal is to upend the space-travel industry and finally make dreams a reality by offering the public several travel packages, each one designed for 100% satisfaction.</p>
